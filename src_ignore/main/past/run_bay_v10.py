...
checkpoint_path = "/workspace/runs/bay_optim_run_1/optimizer_v37.pkl" #for bayesian optim model
best_model_path = "/workspace/runs/bay_optim_run_1/best_model_3.pth"
...
param_space = [
    Categorical([256], name='total_batch_size'),  # Specific values
