...
existing_model_path = "../runs/full_TCEC_run_1/iters/state_dict_v92.pth"
...
with torch.no_grad():
    ...
    while True:
        if first_iteration:
            uci_move, current_node = root_node(250.0)
            first_iteration = False
        else:
            uci_move, current_node = root_node(150.0)
        move = chess.Move.from_uci(uci_move)
        ...
        print("value="+str(5*root_node.get_policy_value(root_node.board)[1]))
